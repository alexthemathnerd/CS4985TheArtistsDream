...
public class FilterPopup {
    ...
    @FXML
    void initialize() {
        this.searchTagsTextField.textProperty().bindBidirectional(this.viewModel.searchTermProperty());
        this.tagsPane.tagsListProperty().bindBidirectional(this.viewModel.searchTagsProperty());
    }
